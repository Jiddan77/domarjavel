    ...
    return (
      <button
        ...
        style={{
          ...
          background: 'rgba(250,249,247,.9)', border: '.5px solid rgba(0,0,0,.15)',
          borderRadius: 10, padding: '6px 12px',
          font: '11.5px/1.4 ui-sans-serif,system-ui,-apple-system,sans-serif',
          fontWeight: 600, cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,.12)',
        }}
      >
        ⚙ Tweaks
      </button>
...
export function TweakSelect({ label, value, options, onChange }: { label: string; value: string; options: TweakSelectOption[]; onChange: (v: string) => void }) {
  return (
...
export function TweakRadio({ label, value, options, onChange }: { label: string; value: string; options: TweakRadioOption[]; onChange: (v: string) => void }) {
